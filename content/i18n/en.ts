...
const en = {
  header: {
    ...
    productTitle: "Sadi",
    productSubtitle: "Process Maturity and Digital Maturity Platform",
    productDescription:
      "A product structure that measures your processes and makes them visible.",

    servicesBadge: "Services",
    servicesFooterText:
      "View all services or get in touch with us directly.",
  ...
  footer: {
    companyDescription:
      "A technology company developing enterprise software, process visibility, and digital transformation focused solutions.",
    ...
    copyright: "© 2026 Tage Yazılım Ltd. Şti. All rights reserved.",
  ...
  home: {
    ...
    product: {
      ...
      sample: {
        ...
        note: "Reassessment with v+1: same process set → new version → proof of improvement",
      },
    },
    ...
    why: {
      badge: "Why Tage?",
      title: "A reliable, measured, and product-supported enterprise technology approach",
      items: [
        "A close fit to enterprise needs",
        "A process-oriented way of thinking",
        "A simple, practical, and clear structure",
        "Creating tangible value through a product approach",
      ],
    },

    finalCta: {
      badge: "Final step",
      title: "Learn more about our products and approach",
      description:
        "You can visit the relevant pages to explore Tage’s enterprise software approach and the Sadi product more closely, or contact us directly.",
