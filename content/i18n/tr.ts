...
const tr = {
  header: {
    ...
    productBadge: "Ürün",
    productTitle: "Sadi",
    productSubtitle: "Süreç Olgunluk ve Dijital Olgunluk Platformu",
    productDescription: "Süreçlerinizi ölçen ve görünür kılan ürün yapısı.",

    servicesBadge: "Hizmetler",
    servicesFooterText:
      "Tüm hizmetleri görün veya doğrudan bizimle iletişime geçin.",
  ...
  footer: {
    ...
    productTitle: "Sadi",
    goToProductPage: "Ürün Sayfasına Git",

    contactTitle: "İletişim",
    whatsappText: "WhatsApp üzerinden yazın",
    linkedinText: "Tage Yazılım LinkedIn",

    copyright: "© 2026 Tage Yazılım Ltd. Şti. Tüm hakları saklıdır.",
  ...
  home: {
    ...
    product: {
      ...
      sample: {
        ...
        comparableLabel: "Kıyaslanabilir",
        riskLabel: "Risk: Kritik",
    ...
    why: {
      badge: "Neden Tage?",
      title: "Güven veren, ölçülü ve ürünle desteklenen kurumsal teknoloji yaklaşımı",
      items: [
        "Kurumsal ihtiyaçlara yakın yaklaşım",
        "Süreç odaklı düşünme biçimi",
        "Sade, uygulanabilir ve net yapı",
        "Ürün yaklaşımı ile somut değer üretme",
      ],
    },

    finalCta: {
      badge: "Son adım",
      title: "Ürünlerimiz ve yaklaşımımız hakkında daha fazla bilgi alın",
      description:
        "Tage’nin kurumsal yazılım yaklaşımını ve Sadi ürününü daha yakından incelemek için ilgili sayfalara geçebilir veya doğrudan bizimle iletişime geçebilirsiniz.",
